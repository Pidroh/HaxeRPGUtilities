...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{105, 109, 26872, 4745537, 5144726, 5393365, 5442204, 5442212, 5443986, 5594513, 5741474, 55034127, 57476627, 76061764, 78945784, 87367608, 117802505, 123289090, 142301684, 157130970, 221637784, 241755125, 284451845, 302979532, 312752480, 328878574, 359333139, 407283053, 437335495, 452737314, 480756972, 501039929, 520590566, 537630174, 572311959, 630156697, 746281503, 785282188, 834174833, 863972113, 873224454, 922671056, 946786476, 981808206, 995006396, 1067353468, 1084548177, 1103412149, 1117069141, 1154676353, 1158363130, 1177754921, 1181037546, 1191633396, 1204816148, 1224901875, 1228056441, 1247875546, 1257164128, 1268715652, 1273207865, 1280549057, 1280845662, 1282943179, 1292233597, 1292432058, 1306622181, 1312884082, 1313416818, 1352786672, 1395555037, 1398464674, 1408123271, 1418202823, 1431819701, 1436822557, 1460447810, 1490610260, 1491380462, 1506824210, 1512997393, 1532710347, 1537812987, 1547539107, 1620824029, 1621420777, 1623148745, 1639293562, 1648581351, 1695182407, 1705629508, 1717792280, 1768617329, 1819702408, 1825849507, 1863059586, 1887113800, 1915412854, 1916009602, 1919096196, 1937159360, 1949824367, 1955468949, 1981972957, 2022294396, 2025055113, 2048392659, 2054707467, 2082663554, 2127021138, 2136217986};
		
		protected static string[] fields = new string[]{"i", "m", "xp", "__a", "get", "len", "map", "max", "min", "pop", "set", "AdvanceArea", "getEnumConstructs", "remove", "__previousException", "filter", "update", "playerTimesKilled", "resize", "necessaryToKillInArea", "__nativeException", "attributesCalculated", "CharacterBaseInfoFormattedString", "methodName", "get_native", "iterator", "lastIndexOf", "hasNext", "message", "reverse", "nOccupied", "insert", "length", "get_message", "native", "array", "contains", "getPlayerTimesKilled", "value", "__nativeStack", "calculatedMax", "cachedIndex", "toString", "equipment", "hashes", "splice", "maxArea", "copy", "DefaultConfiguration", "minimumIncrement", "hero", "__skipStack", "join", "keys", "concat", "next", "enumConstructor", "push", "keyValueIterator", "initial", "current", "size", "sort", "quicksort", "turn", "type", "battleArea", "BaseInformationFormattedString", "vals", "spliceVoid", "cachedKey", "getEnumName", "equipmentSlots", "data1", "createEnumIndex", "createEnum", "__ownStack", "RetreatArea", "timePeriod", "dirty", "posInfos", "concatNative", "nBuckets", "className", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "fileName", "scaling", "toDynamic", "lastUsedBaseAttribute", "allEnums", "attributesBase", "unwrap", "advance", "enemy", "__get", "__set", "level", "__hx_deleteField", "killedInArea", "ChangeBattleArea", "lineNumber", "upperBound", "unshift", "_keys", "enumParameters", "shift", "slice", "timeCount"};
